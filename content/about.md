...
stats:
  ...
  - value: "IN"
    label: "Indiana-based & hands-on"
compareEyebrow: "Template build vs. Bridge Stack build"
compareTemplate:
  heading: "Theme-based builder"
  items:
    - "Generic theme, edited"
    - "Plugin bloat slows load times"
    - "Locked to the builder's rules"
    - "You manage hosting & updates"
compareBridge:
  heading: "Bridge Stack custom build"
  items:
    - "Designed & coded for your brand"
    - "Lean code, built for speed"
    - "No platform lock-in"
    - "We manage hosting, updates & support"
---
