...
export const services = [
	...
	},
	{
		...
		description:
			"We build online stores and landing pages designed to maximize sales and leads. Every element is strategically placed to boost conversions.",
		icon: <IconShield />,
	},
];
...
export default function ServicesSection() {
	return (
		...
		>
			...
			<div className="grid gap-8 md:px-6 lg:grid-cols-2">
				{services.map(({ title, description, icon }, index) => (
					<RevealOnScroll key={title} delay={index * 0.1}>
						...
						>
							<h3 className="mb-2 flex items-center gap-4 text-xl font-medium uppercase">
